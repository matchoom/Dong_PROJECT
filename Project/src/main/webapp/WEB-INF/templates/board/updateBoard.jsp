 ...
 <div class="container">
       ...
       <!-- <input id="wdate" name="wdate" value="${reviewBoard.wdate}" type="hidden" /> --> 
        ...
        <table class="table table-striped table-hover">
            ...
            <tr>
                <th style="padding:13px 0 0 15px;">상품 이름</th>
                <td><input class="form-control" name="title" type="text" value="${board.title}"/></td>
            </tr>
            
            <tr>
                <th style="padding:13px 0 0 15px;">가격</th>
            ...
            <tr>
                <th style="padding:13px 0 0 15px;">상품 이미지</th>
        ...
        <div class="pull-left">
               ...
               <input type="submit" form="insert" class="btn btn-success"  value="수정"  formaction="updateBoard.do" formmethod="post" />
           </div>
         </div>
		</div>
