...
%>
        ...
        <div class="page-header">
            <h1 class="text-primary-gradient fw-medium">${reply.memberNickname}님 에게 쪽지보내기</h1>
        </div>
        ...
        <div align="right">
        <button type="button" class="btn btn-success" onclick="insert()" id="insert">보내기</button>
